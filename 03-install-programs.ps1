...
& cinst -y cake.portable ## Cake build.
& cinst -y NuGet.CommandLine ## NUGET CLIENT
...
## & code --install-extension remote.SSH ## Precisa do VSCode Insider
